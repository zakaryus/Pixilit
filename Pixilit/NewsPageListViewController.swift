...
//    
//    var listOfNewsStories: [NewsPage] = [NewsPage]()
//    var filteredListOfNewsStories: [NewsPage] = [NewsPage]()
...
//    func RefreshList()
//    {
//        Helper.RestMainNewsPageRequest(<#CompletionHandler: (newspage: [NewsPage]) -> ()##(newspage: [NewsPage]) -> ()#>)
//            {
//                bus in
//                
//                println(bus.count)
//                
//                self.listOfNewsStories = bus
